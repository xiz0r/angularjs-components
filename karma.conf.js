...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/step1/step1Module.js',
			'app/modules/step1/step1Ctrl.js',
			'app/modules/step1/step1Route.js',
			'app/modules/step1/step1Service.js',
			'app/modules/step1/step1-test.js',
		],
